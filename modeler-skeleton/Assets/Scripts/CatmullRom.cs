 ...
 */
/*
       Part of this code is adapted from GitHub repo: https://github.com/JPBotelho/Catmull-Rom-Splines
...
public class CatmullRom {
    ...
    public void ClearPoints()
    {
        ...
        splinePoints = new CatmullRomPoint[1];
    }
    ...
    private void InitializeProperties() {
        ...
        if (closedLoop)
            pointsToCreate =
                resolution * controlPoints.Length; //Loops back to the beggining, so no need to adjust for arrays starting at 0
        else
    ...
    private void GenerateSplinePoints() {
        ...
        var closedAdjustment = closedLoop ? 0 : 1;
        for (var currentPoint = 0; currentPoint < controlPoints.Length - closedAdjustment; currentPoint++) {
            var closedLoopFinalPoint = closedLoop && currentPoint == controlPoints.Length - 1;
            ...
            for (var tesselatedPoint = 0; tesselatedPoint < resolution; tesselatedPoint++) {
                ...
                var point = Evaluate(p0, p1, m0, m1, t);
